 ...
 * @brief Additional (on top of Capstone) definitions for RISCV translator.
 */

#ifndef RETDEC_CAPSTONE2LLVMIR_MIPS_RISCV_DEFS_H
#define RETDEC_CAPSTONE2LLVMIR_MIPS_RISCV_DEFS_H
